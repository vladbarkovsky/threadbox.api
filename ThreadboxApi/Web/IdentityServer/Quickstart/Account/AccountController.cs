...
namespace ThreadboxApi.Web.IdentityServer.Quickstart.Account
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl)
        {
            ...
            return View("/Web/IdentityServer/Views/Account/Login.cshtml", vm);
        }
            ...
            if (button != "login")
            {
                if (context != null)
                {
                    ...
                    if (context.IsNativeClient())
                    {
                        ...
                        return this.LoadingPage("/Web/IdentityServer/Views/Shared/Redirect.cshtml", model.ReturnUrl);
                    }
